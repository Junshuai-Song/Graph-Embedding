...
public class FixedCacheMap implements Iterable<Pair<Integer,Float>> {
    ...
    private HashMap<Integer, Short> key2Index; // "Short" to save storage.
    ...
    public FixedCacheMap(int NMAX) {
        ...
        keys   = new int[NMAX + 1];
        key2Index = new HashMap<Integer, Short>();
    }

    public void put(int key, float value){
    	Short index = key2Index.get(key);
    	if (index != null){
    ...
    private void exch(int index1, int index2){
    	...
    	key2Index.put(keys[index1], (short)index2);
    	key2Index.put(keys[index2], (short)index1);
