...
public class Test_Sigmod14_efficiency {
	...
	public static void main(String[] args) throws IOException {
		int topk = 20;
		int maxId = 100;
		String[] datas = {"youtube-groupmemberships.txt","actor_movie.txt","dblp-author_pub.txt","livejournal-groupmemberships.txt","delicious_delicious-ti_delicious-ti.txt"};
		int[] sizes = {124325,511463, 5425963,10690276,38289740};
