...
public class NormalCombineBatchSingleWalkVertexReuse extends
	...
	public static final String countFlag = MyConfiguration.countFlag;
	public static final int V = MyConfiguration.V;
	public static final int stopV = MyConfiguration.stopV;
	public static final int machineCount = MyConfiguration.machineCount;
	public static final int BATCH_SIZE = MyConfiguration.BATCH_SIZE;
	public static final String SEPARATOR_KV = MyConfiguration.SEPARATOR_KV;

	public static final float C = (float) MyConfiguration.C;
	public static final int SAMPLE = MyConfiguration.SAMPLE;
	public static final int STEP = MyConfiguration.STEP; // the max length of a double path.
	public static final int CYCLE =MyConfiguration.CYCLE;
	public static final int pathLen = MyConfiguration.pathLen;   // normally, shouldn't be larget than 127.
	public static final int targetLen = MyConfiguration.targetLen;
	public static final int TOPK = MyConfiguration.TOPK;
	public static final int M = MyConfiguration.M;
	...
	public static void main(String[] args) throws IOException,
		...
		GiraphJob job = new GiraphJob(new Configuration(), "s_walk_batch_"
				+ countFlag+"_normalcombine_reuse_"+machineCount+"_"+MyConfiguration.stopV);
