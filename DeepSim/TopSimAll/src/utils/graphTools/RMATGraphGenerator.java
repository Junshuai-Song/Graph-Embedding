...
//        int nThreads = Runtime.getRuntime().availableProcessors();
    ...
    public static void main(String[] args) throws IOException {
    	...
    	int avgD = 50;
    	for (int v:vs){
            String outputFile = MyConfiguration.basePath+"/power_graph/temp/power_biGraph_"+v+"_"+avgD+".txt";
            int numVertices = v / 2;
            ...
            generator.execute();
            generator.concatFiles(MyConfiguration.basePath+"/power_graph/temp",  MyConfiguration.basePath+"/power_graph/power_biGraph_"+v+"_"+avgD+".txt");
